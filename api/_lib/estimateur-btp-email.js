...
// Bloc HTML "comment ça marche" partagé par les deux emails qui présentent
// l'Estimateur BTP :
//   - api/stripe-webhook.js (email de livraison du Kit Pro Artisan BTP, qui
//     inclut l'appli en bonus)
//   - api/estimateur-btp-essai.js (email de bienvenue au démarrage de
//     l'essai gratuit)
// Centralisé ici pour ne pas dupliquer le texte et les images dans les deux
