...
// Revérifie l'état d'accès (essai en cours / expiré / acheté) d'un email
// pour l'Estimateur BTP — utilisé en tâche de fond par estimateur-btp.html
// quand une connexion réseau est disponible (l'appli reste utilisable hors
// ligne entre deux vérifications, avec le dernier état connu), et juste
// après un retour de paiement Stripe pour confirmer l'achat sans attendre le
// webhook.
//
