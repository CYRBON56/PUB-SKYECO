...
// de modifier les coordonnées d'un prospect de n'importe quel mini-site sur
// simple présentation d'un draft_id, sans aucune vérification.
...
export default async function handler(req, res) {
  ...
  const { id, draft_id, token, nom, ville, departement, telephone, adresse, email } = req.body || {};
  if (!id || !draft_id || !token) {
